...
<img src="https://latex.codecogs.com/png.latex?\inline&space;\dpi{300}&space;\bg_white&space;\huge&space;\frac{P}{E}=\frac{Share\:Price}{Earnings\:Per\:Share}" title="\huge \frac{P}{E}=\frac{Share\:Price}{Earnings\:Per\:Share}" width=220/>
